...
const reviews = [
  ...
  {
    name: 'Иван Петров',
    text: 'Имахме сериозен проблем с хлебарки в общите части на сградата. Екипът реагира бързо, обясни целия процес и извърши обработката изключително професионално. Резултатите се видяха още след първите дни. Препоръчвам с две ръце!',
  },
]
      ...
      <header className="about-hero section-reveal">
        <div className="about-hero__copy">
          ...
          <p className="lead">
            ...
            вие сте сигурни. <strong>Защото вредителите не чакат и ние също.</strong>
          </p>
        </div>
      ...
      <section className="about-story section-reveal" aria-labelledby="about-story-title">
        ...
        <article className="about-story__copy">
          ...
          <p>
            ...
            опит, правилните препарати и оборудване, и желание да свършим професионално и без компромис с качеството,
            така че да сте спокойни след нас.
          </p>
          <p>
